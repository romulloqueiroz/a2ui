...
describe('Example: User Profile (basic) (v0.8)', () => {
  ...
  beforeEach(async () => {
    fixture = await loadExample({name: 'User Profile (basic)', version: Version.V0_8});
  ...
  it('should dispatch follow action on button click', async () => {
    ...
    expect(loggedAction.name).toBe('follow');
  });
});
